...
namespace Singletons
{
	...
	void Renderer::init_shaders()
	{
		...
		for (fs::path const& shader_path : m_renderer_wrapper.get_shaders(glsl, search_paths))
		{
	...
	{
		{
			...
			for (std::unique_ptr<renderer::Uniform>& uniform : m_renderer_wrapper.set_shader(glsl, shader))
			{
